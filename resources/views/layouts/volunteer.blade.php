...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <div class="form-control-dark w-100 rounded-0 border-0"></div>
            <a style="background-color: rgba(0, 0, 0, 0.25); width: 135.219px; text-align:center;" class="dropdown-item nav-link px-3" href="{{ route('logout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit();">
                {{ __('Sign out') }}
            </a>
